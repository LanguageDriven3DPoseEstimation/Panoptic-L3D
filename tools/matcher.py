...
from tools.misc import nested_tensor_from_tensor_list, interpolate, box_cxcywh_to_xyxy, generalized_box_iou
...
def build_matcher(cfg):
    return HungarianMatcher(cost_con=0, cost_dice=cfg.LOSS.LOSS_DICE,
                            cost_cls=cfg.LOSS.LOSS_CLS, cost_box = cfg.LOSS.LOSS_BBOX, cost_giou = cfg.LOSS.LOSS_GIOU, num_classes=1)
