...
def main(args):
    ...
    dataset_train = build_dataset(image_set='train', dataset_file=config.DATA.NAME, cfg=config)
    dataset_test = build_dataset(image_set='test', dataset_file=config.DATA.NAME, cfg=config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_root', type=str, default='/root/autodl-tmp/')
    parser.add_argument('--batch_size', type=int, default=1, help='batch size')
    parser.add_argument('--num_epochs', type=int, default=20, help='number of training epochs')
    parser.add_argument('--num_workers', type=int, default=12,help='number of workers for data')
    parser.add_argument('--output_path', type=str, default='/root/autodl-tmp/output/', help='output directory')
